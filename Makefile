all: son/son sip/sip client/app_simple_client server/app_simple_server client/app_stress_client server/app_stress_server client_IM server_IM

client_IM:client.c include/list.h client/stcp_client.c topology/topology.c common/seg.c
	@gcc -Wall -pedantic -std=c99 -g client.c client/stcp_client.c topology/topology.c common/seg.c -o client_IM -lpthread -lcurses

server_IM:server.c include/list.h server/stcp_server.c topology/topology.c common/seg.c
	@gcc -Wall -pedantic -std=c99 -g server.c server/stcp_server.c topology/topology.c common/seg.c -o server_IM -lpthread
